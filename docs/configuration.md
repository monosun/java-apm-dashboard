...
```
java-monitor-1.12.0.jar 더블클릭 ❌  →  bin\start.bat 더블클릭 ✅
```
...
java -Xms512m -Xmx2g -XX:+UseG1GC \
     -jar java-monitor-1.12.0.jar /etc/monitor/prod.properties
```
