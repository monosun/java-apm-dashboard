...
```
java-monitor-1.12.1.jar 더블클릭 ❌  →  bin\start.bat 더블클릭 ✅
```
...
java -Xms512m -Xmx2g -XX:+UseG1GC \
     -jar java-monitor-1.12.1.jar /etc/monitor/prod.properties
```
